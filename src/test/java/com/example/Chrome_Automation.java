...
import org.openqa.selenium.TakesScreenshot;
public class Chrome_Automation 
{
	WebDriver driver;
	@BeforeClass
	public void beforeClass() 
	{
		System.setProperty("webdriver.chrome.driver","C:\\kani\\help\\ChromeDriver\\chromedriver.exe");
	...
	@Test(priority = 1)
	public void Chrome_Login() throws InterruptedException 
	{
		try 
		{
		...
		Chrome_Screenshot(driver,"Chrome_Login");
	}
	
	@Test(priority = 2)
	public void Chrome_Scroll() throws InterruptedException
	{
		Thread.sleep(2000);
		...
		Chrome_Screenshot(driver,"Chrome_Scroll");
	}
	...
	public void Chrome_Search() throws InterruptedException 
	{
		...
		Chrome_Screenshot(driver,"Chrome_Search");
	}

	@Test(priority = 4)
	public void Chrome_Load() throws InterruptedException 
	{
		...
		Chrome_Screenshot(driver,"Chrome_Load");
	}

	@Test(priority = 5)
	public void Chrome_ScrollFrequency() throws InterruptedException 
	{
		Thread.sleep(2000);
		long start = System.currentTimeMillis();
		...
		Chrome_Screenshot(driver,"Chrome_ScrollFrequency");
	}

	@Test(priority = 6)
	public void Chrome_DownloadImages() throws InterruptedException 
	{
		WebElement img = driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[3]/div[1]/div[2]/div[9]/div[4]/div[3]/div/div/div/div[1]/img"));
		...
		Chrome_Screenshot(driver,"Chrome_DownloadImages");
	}

	@Test(priority = 7)
	public void Chrome_ScreenResolution() throws InterruptedException 
	{
		Thread.sleep(1000);
		...
		Chrome_Screenshot(driver,"Chrome_ScreenResolution");

	}
	
	public static void Chrome_Screenshot(WebDriver driver,String screenshotName)
	{
