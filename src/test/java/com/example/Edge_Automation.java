...
public class Edge_Automation 
{
	WebDriver driver;
	@BeforeClass
	public void beforeClass() 
	{
		System.setProperty("webdriver.edge.driver","C:\\kani\\help\\EdgeDriver\\msedgedriver.exe"); 
	...
	@Test(priority = 1)
	public void Edge_Login() throws InterruptedException 
	{
		try 
		{
			System.out.println("\nEdge Browser Result:\n");
		...
		Edge_Screenshot(driver,"Edge_Login");
	}

	@Test(priority = 2)
	public void Edge_Scroll() throws InterruptedException 
	{
		Thread.sleep(2000);
		...
		Edge_Screenshot(driver,"Edge_Scroll");
	}
	...
	public void Edge_Search() throws InterruptedException 
	{
		...
		Edge_Screenshot(driver,"Edge_Search");
	}

	@Test(priority = 4)
	public void Edge_Load() throws InterruptedException 
	{
		...
		Edge_Screenshot(driver,"Edge_Load");
	}

	@Test(priority = 5)
	public void Edge_ScrollFrequency() throws InterruptedException 
	{
		Thread.sleep(2000);
		long start = System.currentTimeMillis();
	    ...
	    Edge_Screenshot(driver,"Edge_ScrollFrequency");
	}

	@Test(priority = 6)
	public void Edge_DownloadImages() throws InterruptedException 
	{
		WebElement img = driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[3]/div[1]/div[2]/div[9]/div[4]/div[3]/div/div/div/div[1]/img"));
		...
		Edge_Screenshot(driver,"Edge_DownloadImages");
	}

	@Test(priority = 7)
	public void Edge_ScreenResolution() throws InterruptedException 
	{
		Thread.sleep(1000);
		...
		Edge_Screenshot(driver,"Edge_ScreenResolution");

	}
	public static void Edge_Screenshot(WebDriver driver,String screenshotName)
	{
