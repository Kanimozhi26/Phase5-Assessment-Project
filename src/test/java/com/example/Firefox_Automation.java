...
public class Firefox_Automation 
{
	...
	{
		System.setProperty("webdriver.gecko.driver","C:\\kani\\help\\GeckoDriver\\geckodriver.exe"); 
	...
	@Test(priority = 1)
	public void Firefox_Login() throws InterruptedException 
	{
		try 
		{
			System.out.println("\nFirefox Browser Result:\n");
		...
		Firefox_Screenshot(driver,"Firefox_Login");
	}

	@Test(priority = 2)
	public void Firefox_Scroll() throws InterruptedException 
	{
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		Firefox_Screenshot(driver,"Firefox_Scroll");
	}

	@Test(priority = 3)
	public void Firefox_Search() throws InterruptedException 
	{
		Thread.sleep(1000);
		...
		Firefox_Screenshot(driver,"Firefox_Search");
	}

	@Test(priority = 4)
	public void Firefox_Load() throws InterruptedException 
	{
		...
		Firefox_Screenshot(driver,"Firefox_Load");
	}

	@Test(priority = 5)
	public void Firefox_ScrollFrequency() throws InterruptedException 
	{
		Thread.sleep(2000);
		long start = System.currentTimeMillis();
		...
		Firefox_Screenshot(driver,"Firefox_ScrollFrequency");

	}

	@Test(priority = 6)
	public void Firefox_DownloadImages() throws InterruptedException 
	{
		WebElement img = driver.findElement(By.xpath("//*[@id=\"container\"]/div/div[3]/div[1]/div[2]/div[9]/div[4]/div[3]/div/div/div/div[1]/img"));
		...
		Firefox_Screenshot(driver,"Firefox_DownloadImages");
	}

	@Test(priority = 7)
	public void Firefox_ScreenResolution() throws InterruptedException 
	{
		Thread.sleep(1000);
		...
		Firefox_Screenshot(driver,"Firefox_ScreenResolution");
	}
	
	public static void Firefox_Screenshot(WebDriver driver,String screenshotName)
	{
